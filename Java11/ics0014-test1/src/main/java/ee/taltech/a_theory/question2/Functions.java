...
public class Functions {
    ...
    //  A [] function is a piece of code that takes in variables and returns an output | Specification: (except when it is void)
    ...
    //  D [x] static methods means that the method returns no value
